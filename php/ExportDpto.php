...
if (!isset($deptos)) {
    ...
    $Excel->getProperties()->setCreator('Programmer aliance Reportes')
        ->setTitle('Clientes ' . $deptos)
        ->setDescription('Reporte Clientes por Departamento');

    $Excel->setActiveSheetIndex(0);
    $Excel->getActiveSheet()->setTitle('Clientes por Departamento');
    $Excel->getActiveSheet()->setCellValue('A1', 'Departamento');
    $Excel->getActiveSheet()->setCellValue('B1', 'Total Clientes');
    ...
    header("Content-Disposition: attachment; filename=Clientes " . $deptos . ".xls");
    ...
    $Excel->setActiveSheetIndex(0);
    $Excel->getActiveSheet()->setTitle('Clientes por Ciudad');
    $Excel->getActiveSheet()->setCellValue('A1', 'Ciudad');
    $Excel->getActiveSheet()->setCellValue('B1', 'Total Clientes');
